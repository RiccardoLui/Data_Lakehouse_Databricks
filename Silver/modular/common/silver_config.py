...
# MAGIC Central configuration shared by all Silver notebooks.
...
# Pipeline order. Paths are relative to pipeline/00_run_silver_pipeline.
PIPELINE_NOTEBOOKS = [
    "../notebooks/01_silver_crm_customer",
    "../notebooks/02_silver_crm_product",
    "../notebooks/03_silver_crm_sales",
    "../notebooks/04_silver_erp_customer_demographics",
    "../notebooks/05_silver_erp_customer_location",
    "../notebooks/06_silver_erp_product_category",
    "../notebooks/07_silver_diagnostics",
]