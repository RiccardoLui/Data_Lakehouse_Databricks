...
# ///
# MAGIC %md
# MAGIC # Silver - CRM Sales
# MAGIC Cleans `bronze_crm_sales_details` using the shared config and shared transformation functions.
...
TABLE_KEY = "bronze_crm_sales_details"
